...
<html>
    ...
    <body>
        ...
        <div id="show-segment" class="content scaffold-show" role="main">
            ...
            <f:display bean="segment" />
            <g:form resource="${this.segment}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.segment}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
